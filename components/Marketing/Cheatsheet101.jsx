...
export default function CheatSheet101() {
    ...
    async function login() {
        ...
        try {
            ...
            console.log(address);
            const walletJSON = await fetch(`https://staging-backend.relayx.com/api/user/balance2/${address}`);
            const response_data = await walletJSON.json();
            const { collectibles } = response_data.data;
            console.log({ collectibles });
            const selected = collectibles.filter(c => c.origin === 'cb39db1f05e2a4fccc09bdb799b1c1997a7edd8f5653a798c7b5fa666b20ecab_o2');
    ...
    <div>
        ...
        <Container> {isLoggingIn && 'Logging In...'}</Container>
        {canView &&
            <Container size="lg">
